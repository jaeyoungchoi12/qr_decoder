(() => {
  ...
  const I18N = {
    ko: {
      _name: "한국어",
      subtitle: "이미지에서 QR 코드를 읽어보세요 — 끌어다 놓거나 붙여넣거나 업로드하면 즉시 디코딩됩니다.",
    ...
    en: {
      _name: "English",
      subtitle: "Read a QR code from an image — drag, drop, paste, or upload to decode instantly.",
      ...
      learnMore: "Learn more about QR Decoder",
      ...
      howTitle: "How to decode a QR code from an image",
    ...
    zh: {
      _name: "中文",
      subtitle: "从图片中读取二维码 — 拖放、粘贴或上传即可即时解码。",
      dzTitle: "将二维码图片拖到这里",
    ...
    ja: {
      _name: "日本語",
      subtitle: "画像からQRコードを読み取り — ドラッグ＆ドロップ・貼り付け・アップロードで即座にデコード。",
      ...
      learnMore: "QR Decoder について詳しく見る",
